...
AnimalesFacil = ["perro","vaca","delfin","caballo","gato","leon","panda","jirafa","pez","jaguar","pajaro","mono","ajolote","ardilla","conejo","zorro","cerdo","rinoceronte","tortuga","chiva","aguila"]

ColoresFacil = ["amarillo","verde","rojo","violeta","turquesa","marron","naranja","aguamarina","dorado","blanco","fucsia","salmon","gris","azul","cian","rosa","negro","purpura","lavanda"]

DeportesFacil = ["atletismo","esgrima","ciclismo","golf","natacion","tenis","baloncesto","boxeo","futbol","hockey","voleibol","judo","beisbol","patinaje","snowboard","surf","karate","remo","lucha","taekwondo"]

PaisesIntermedio = ["turquia","qatar","suecia","argentina","ucrania","brasil","canada","dinamarca","francia","polonia","italia","jamaica","marruecos","senegal","mexico","gales","japon","croacia","inglaterra","alemania"]

ComidasIntermedio = ["guacamaya","torta","mole","pozole","palomitas","crepas","paella","poutine","tacos","tofu","pescado","sopes","fajitas","croissant","arepas","langosta","elote","chocolate","chilaquiles","enchiladas"]

MarcasIntermedio = ["adidas","honda","sony","whatsapp","canon","pinterest","facebook","airbnb","starbucks","youtube","colgate","adobe","microsoft","nescafe","panam","toyota","gillete","nintendo","playstation","google"]

FlorDificil = ["hortensia","azalea","pensamiento","orquidea","margarita","hibisco","bugambilia","lavanda","dalia","azucena","gladiolo","nomeolvides","ixora","stapelia","clematis","begonia","gazania","petunia","ranunculo","verbena"]

CiudadesDificil = ["villahermosa","aguascalientes","poroy","batman","bankok","xbox","copenhague","melbourne","amsterdam","barcelona","shanghai","zurich","sidney","pekin","chicago","osaka","helsinki","estambul","oporto","manchester"]

InglesDificil = ["chemical","bought","nonplussed","whom","account","conversation","friend","group","indeed","international","knowledge","language","magazine","measure","newspaper","opportunity","particular","performance","yesterday","weekend"]
